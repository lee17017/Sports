...
public class MainMenuUIController : MonoBehaviour
{
    ...
    private void InitializeLevelSelection(int maxLevel, int unlockedLevel)
    {
        ...
        // Endless lvl always unlocked
        Button endless = Instantiate(_levelSelectionButton, _levelSelectionPanel, false);
        endless.GetComponent<LevelSelectionButton>().Initialize(GameManager.Instance, 10);
    }
